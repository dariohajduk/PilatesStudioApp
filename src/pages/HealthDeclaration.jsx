  ...
  return (
    <div ref={declarationRef}>
      <div className="max-w-xl mx-auto bg-white p-5 rounded-xl shadow-lg ">
        <h1 className="font-alef text-xl mb-3 text-center">
          טופס הצהרת בריאות
        </h1>
        ...
        <p className="mb-3">
          {" "}
          3. הנני מודע/ת לכך שההשתתפות בפעילות נעשית מרצוני החופשי ועל אחריותי
          בלבד.{" "}
        </p>
        <p className="mb-3">
          {" "}
          5. אני מתחייב/ת להודיע לצוות הסטודיו על כל מגבלה רפואית, כאב, פציעה או
          הרגשה חריגה במהלך האימון.
        </p>
        <p className="mb-3">
          {" "}
          6. אני משחרר/ת את הסטודיו, בעליו, עובדיו ונציגיו מכל אחריות במקרה של
          נזק גופני או נזק אחר, אשר ייגרם במהלך האימונים או בעקבותיהם.
        </p>
